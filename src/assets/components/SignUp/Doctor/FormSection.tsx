...
const FormSection: React.FC = () => {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500">  Already have an account? <a href="/login" className="text-blue-500">Log in</a>
      </p>
      ...
      <form className="mt-6 space-y-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-white p-2 text-[#666] border rounded-md focus:outline-none focus:border-blue-500"
          />
          <span className="absolute right-2 top-2 cursor-pointer text-gray-500">👁</span>
        </div>
        ...
        <button className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 mt-4"> Continue </button>
      </form>
    </div>
  );
};
