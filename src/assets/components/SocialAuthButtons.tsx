...
const SocialAuthButtons: React.FC = () => {
  return (
    <div className="flex justify-between mt-4">
      <button className="flex items-center justify-center w-full text-[white] border bg-blue-500 rounded-md py-2 mr-2 hover:bg-gray-100 hover:text-blue-700">
        <img src="/facebook.svg" alt="Facebook" className="h-5 mr-2" />Facebook</button>
